...
mainTl.add(starTl, 0)
gsap.globalTimeline.timeScale(0.5);    //  圣诞树开始绘画时小光点动画的绘画速率，越大越快1.5

setTimeout( function(){
  var element = document.getElementById("header");
  element.innerHTML = "闫老板,    圣诞快乐!";
...
element.innerHTML = "这是在一起的第一个圣诞，我在这里许愿，希望我们能岁岁年年";
  var element = document.getElementById("p1");
element.innerHTML = " <br />    Yours 兜先生";
